...
@section('sidebar')
    <ul class="nav nav-sidebar">
      <li id="index"><a href="http://localhost/JWHelper/public/admin/index"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> 课程列表</a></li>
    ...
    <ul class="nav nav-sidebar">
      <li id="teacherList"><a href="http://localhost/JWHelper/public/admin/teachersList"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> 教师列表</a></li>
      <li id="studentList"><a href="http://localhost/JWHelper/public/admin/studentsList"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> 学生列表</a></li>

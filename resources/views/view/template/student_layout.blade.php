...
@section('sidebar')
	@parent
      ...
      <ul class="nav nav-sidebar">
          <li id="resource"><a href="{{$baseURL.'/resource'}}"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> 课程资源</a></li>
          ...
          <li id="homework"><a href="{{$baseURL.'/lessonHomework'}}"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> 作业</a></li>

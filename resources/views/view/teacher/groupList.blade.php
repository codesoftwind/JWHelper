...
<div>
	<div class="col-md-4 text-center" style='font-size:1.0em;padding-top: 1em'>{{$group->groupName}}</div>
  	<div class="col-md-4 text-center" style='font-size:1.0em;padding-top: 1em'>{{$group->headName}}</div>
